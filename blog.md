...
如果你也在准备AI相关的面试，这个项目可以这样讲：

**开场：**
> "我做了一个Agent记忆+知识库管理工具，解决AI Agent的三大痛点：记不住、容易幻觉、不透明。"

**技术实现：**
> "用ChromaDB存储记忆和知识，用Embedding做语义检索，用RAG让Agent基于真实知识回答。还有一个幻觉检测模块，用LLM评估回答的准确性。"

**难点：**
> "记忆的检索是个挑战，需要平衡相关性和重要性。幻觉检测的准确性依赖prompt设计，我迭代了很多版本。"

**成果：**
> "Agent可以记住用户偏好，基于知识库回答问题，还能检测和标记幻觉。"
